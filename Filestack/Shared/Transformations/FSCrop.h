...
- (instancetype _Nullable)initWithX:(NSNumber * _Nonnull)x y:(NSNumber * _Nonnull)y width:(NSNumber * _Nonnull)width height:(NSNumber * _Nonnull)height NS_DESIGNATED_INITIALIZER;
